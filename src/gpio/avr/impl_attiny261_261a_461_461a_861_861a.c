 ...
 *
 * Pin configuration for attiny261/attiny261a/attiny461/attiny461a/attiny861/attiny861a.
 */
#if	defined(__AVR_ATtiny261__) || defined(__AVR_ATtiny261A__) || defined(__AVR_ATtiny461__) || defined(__AVR_ATtiny461A__) || defined(__AVR_ATtiny861__) || defined(__AVR_ATtiny861A__)
...
const gpio_timer_t PROGMEM	_gpio_timers[] =
{
	/* timer_1A */
	{
		...
		(uint8_t) ~((1<<PWM1A)|(1<<COM1A1)|(1<<COM1A0)),
		(1<<PWM1A)|(1<<COM1A1),
		REG_TO_OFFSET(OCR1A)
	},
	...
	/* timer_1D */
	{
		...
		GPIO_TIMER_TYPE_10BIT,
#endif
		REG_TO_OFFSET(TCCR1C),
		(uint8_t) ~((1<<PWM1D)|(1<<COM1D1)|(1<<COM1D0)),
		(1<<PWM1D)|(1<<COM1D1),
		REG_TO_OFFSET(OCR1D)
	}
};
...
const struct _gpio_pin PROGMEM	_gpio_pins[GPIO_PIN_COUNT] =
{
	...
	/* #13 - D13/A8 (PB5/ADC8/OC1D/PCINT13) */
	{
		...
		8,
		&_gpio_timers[2] - &_gpio_timers[0] /* timer_1D */
	},
...
#endif	/* __AVR_ATtiny261__ || __AVR_ATtiny261A__ || __AVR_ATtiny461__ || __AVR_ATtiny461A__ || __AVR_ATtiny861__ || __AVR_ATtiny861A__ */
